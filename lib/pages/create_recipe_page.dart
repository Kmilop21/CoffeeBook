...
class _CreateRecipePageState extends State<CreateRecipePage> {
  ...
  Future<void> requestPermissions() async {
    if (await Permission.storage.request().isGranted) {
      ...
      // Permission denied; show an alert or handle it gracefully
    }
  }
  ...
  void _saveRecipeToDatabase() {
    if (_formKey.currentState!.validate()) {
      // Here we would convert the recipe data into a `Recipe` instance and save it.
      final newRecipe = Recipe(
        id: null, // Auto-generated by the database
        name: _nameController.text,
        instructions: _instructionsController.text,
        image: _image?.path ?? '', // Save the path for now
        type: "custom", // Customize this as needed
        ingredients: _ingredients,
        preparationTime: 10, // Placeholder time
      );
  ...
  void initState() {
    super.initState();
    requestPermissions(); // Request storage permissions on page load
  }
